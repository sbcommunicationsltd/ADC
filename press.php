...
<title>Asian Dinner Club - for Single Asian Professionals :: press ::  Asian Dinner Club</title>
...
<!--<a href="http://twitter.com/salima_manji"><img src="images/twitterheart.png" width="32" height="32" border="0" /></a><a href="http://www.facebook.com/group.php?gid=39319432171"><img src="images/facebookheart.png" width="32" height="32" border="0" /></a>-->
</div>
</div>
<div id="maincontent">
<div id="innercontent">
...
if(!isset($_GET['id']))
{
	...
	while($row = mysql_fetch_array($result))
	{
		$gid = $row['ID'];?>
		<tr>
			<td style='color:#ec008c;'><?php $date = date('d.m.Y', strtotime($row['Date'])); echo $date;?></td>
		</tr>
		<tr>
...
else
{
	...
	<table width='100%' cellspacing='2' cellpadding='2' border='0'>
	<tr>
		<td style='color:#ec008c;'><?php $date = date('d.m.Y', strtotime($row2['Date'])); echo $date;?><span style='float:right;'><img src="images/<?php echo $row2['Image_Path'];?>" border='0' height='115' /></span></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td align='left'>To read the full article, please go to <br/><a href="<?php echo $row2['Hyperlink'];?>" target='_blank' border='0' style='color:blue;' onmouseover="this.style.color='#FF00FF';" onmouseout="this.style.color='blue';"><?php echo $row2['Hyperlink'];?></td>
	</tr>
	<?php
	}?>
	<tr>
...
<a href='http://www.facebook.com/group.php?gid=39319432171'><img src='images/Facebook_Badge.gif' border='0' alt='Find us on Facebook' /></a>
</span>
