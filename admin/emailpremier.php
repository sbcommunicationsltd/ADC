...
{?>
	...
	<tr>
		<th width='33%'><input type='radio' name='email' value='All' <?php if(isset($_GET['email'])){if($_GET['email'] == 'all'){ echo "checked='checked'"; }}else{ echo "checked='checked'"; }  ?> onclick="location.href='?email=all';" />All Premier Members</th>
	...
	<tr>
		<td colspan='3'>
			<?php
			$query = "SELECT EmailAddress FROM Premier_Membership";
			if(isset($_GET['email']))
			{
				$gen = $_GET['email'];
				if($gen == 'male')
					...
					<tr>
						...
						<td><?php
							if(isset($_GET['email']))
							{
								...
								if($gen == 'all')
								{
									echo 'All Premier Members';
								}
								elseif($gen == 'male')
								{
									echo 'All Male Premier Members';
								}
								else
								{
									echo 'All Female Premier Members';
								}
							}
							else
							{
...
else
{
	...
	//$toemails = 'sumita.biswas@gmail.com,sumi@blueyonder.co.uk';
	...
	{?>
		...
		<table cellspacing='0' cellpadding='0' border='0'>
			<tr>
				<td><img src="../images/sumi_buttons_04.png" width="11" height="19" alt=""></td>
				<td class='singlebutton'><a title='Send More Emails' href="emailpremier.php">Send More Emails</a></td>
				<td><img src="../images/sumi_buttons_06.png" width="11" height="19" alt=""></td>
			</tr>
		</table>
		</p>
