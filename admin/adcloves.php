...
<title>Asian Dinner Club - for Single Asian Professionals :: ADMIN AREA - ADC Loves ::  Asian Dinner Club</title>
...
<div id="wrapper">
	...
	<div id="maincontent">
		...
		<!-- main content area -->
			...
			<div id="contentcol1">
				<h2>Admin Area</h2>
				<img src="../images/adcloves.gif" alt="Asian Dinner Club Loves" width="408" height="50"/>
				<div>
					<!-- DELETE SECTION! -->
					...
					if(isset($_GET['edit']))
					{
						...
						<table width='600' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
							<tr>
								<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Edit this Item</div></td>
							</tr>
								...
								<input type='hidden' name='submitedit' />
									...
									<table cellspacing='0' cellpadding='0' border='0'>
										<tr>
											...
											<td>&nbsp;</td>
											<td><img src="../images/sumi_buttons_04.png" width="11" height="19" alt=""></td>
											<td class='singlebutton'><a title="Back" name='back' href="../admin/adcloves.php">Back to Admin ADC Loves Area</a></td>
											<td><img src="../images/sumi_buttons_06.png" width="11" height="19" alt=""></td>
										</tr>
									</table>
								</td>
					...
					{?>
						<form method='post' name='additem' enctype="multipart/form-data">
							<table width='600' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
								<tr>
									<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Add Item</div></td>
								</tr>
								<tr>
									<td colspan='2'>&nbsp;</td>
								</tr>
						...
						if($num_rows != 0)
						{
							while($row = mysql_fetch_array($result2))
							{
								...
								<table width='500' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
									<tr>
										<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Asian Dinner Club Loves... <?php echo $page;?></div></td>
									</tr>
									<tr>
										<td colspan='2'>&nbsp;</td>
									</tr>
	...
	<div id="footer">
		<div class="footer2col1"><a href="../terms.php">TERMS</a>&nbsp;|&nbsp;<a href="../sitemap.php">SITE MAP</a>&nbsp;|&nbsp;<a class='active' href="../admin/">ADMINISTRATOR</a>&nbsp;|&nbsp;<a class='active' href="../admin/logout.php">LOG OUT</a></div>
	</div>
	<div id="footer2">
		...
		<div class="footer2col2">redeveloped by: <a href="http://www.sbcommunications.co.uk" target='_blank'>S B Communications Ltd.</a></div>
	</div>
</div>
</body>
</html>