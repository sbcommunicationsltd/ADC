...
if(isset($_GET['edit']))
{
	...
	<table width='600' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
		<tr>
			<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Edit this Press Release</div></td>
		</tr>
...
{?>
	<form method='post' name='addpress' enctype="multipart/form-data">
		<table width='600' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
			<tr>
				<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Add a Press Release</div></td>
			</tr>
			<tr>
				<td colspan='2'>&nbsp;</td>
			</tr>
	...
	if($num_rows != 0)
	{
		while($row = mysql_fetch_array($result2))
		{
			...
			<table width='500' align='center' style="border:1px solid #d0d3d5; background-color:transparent;" cellspacing='2' cellpadding='2'>
				<tr>
					<th colspan="2" bgcolor="#ec008c"><div style="color: #00225d;">Press Release <?php echo $page;?></div></td>
				</tr>
				<tr>
